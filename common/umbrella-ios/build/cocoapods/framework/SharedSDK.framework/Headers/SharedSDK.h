...
- (instancetype)initWithGame:(SSDKGame *)game __attribute__((swift_name("init(game:)"))) __attribute__((objc_designated_initializer));
- (SSDKGame *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SSDKSearchEventGameClicked *)doCopyGame:(SSDKGame *)game __attribute__((swift_name("doCopy(game:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SSDKGame *game __attribute__((swift_name("game")));
@end;
